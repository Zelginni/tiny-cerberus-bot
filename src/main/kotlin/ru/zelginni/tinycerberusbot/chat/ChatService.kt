...
class ChatService(
    ...
    fun changeWarnLimit(telegramId: String, warnLimit: Int) {
        changeChat(telegramId) {this.warnLimit = warnLimit}
    }

    fun changeFullStatisticsLimit(telegramId: String, fullStatisticsLimit: Int) {
